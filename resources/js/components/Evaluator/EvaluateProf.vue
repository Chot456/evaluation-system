    ...
    <v-content style="background-color: #eef1f6">
      <v-card class="mx-auto mt-10" max-width="1300">
        <v-toolbar color="main" dark>
          <v-toolbar-title>Faculty Evaluatiasdon</v-toolbar-title>
            ...
            <v-col>
              <div v-for="(evalinfo, i) in evaluteinfodata">
                <div v-if="evalinfo.studId !== null">
                  ...
                  <div>
                    Student Name:
                    {{ evalinfo.firstName + " " + evalinfo.lastName }}
                  </div>
                  <div>
                ...
                <div>Course: {{ evalinfo.courseDescription }}</div>
                <div></div>
          ...
          <v-row class="fill-height">
            <v-col>
              ...
              <div class="ml-5">
                ...
                information for purposes of instructional analysis and
                improvement. Please try to be both objective and candid in your
                responses so as to maximize the value of the feedback. Your
                Judgement should reflect that type of teaching you think is best
                for this particular course and your particular learning style.
                Try To assess each behaviour independetly rather than letting
                your overall impression of the instructor determine each
                individual rating. Each section of the inventory begins with a
                definition of the category of teaching to be assessed in that
                section. For each specific teaching behaviour, please indicate
                the frequency with which he/she exhibits the behaviour in
                question. Please use the following rating scale ina making your
                judgement.</br>
                 5 = almost always 4 = often 3 = sometimes 2 = rarely
                1= almost never
              </div>
            </v-col>
          </v-row>
...
export default {
  ...
  methods: {
    SubmitEval(textarea, questiondata, usertypedescr, empid, userevalid) {
      const concat = {};
      var key = 0;
      var count = 0;
      ...
      axios({
        method: "put",
        url:
          "http://localhost:8080/evaluation-system/public/api/updatePublish/"  + this.sectionid,
        data: {
          publish: "yes"
        },
      });
    ...
    getquestion: function () {
      ...
      axios
        .get(
          "http://localhost:8080/evaluation-system/public/api/questionaire/userType/" +
